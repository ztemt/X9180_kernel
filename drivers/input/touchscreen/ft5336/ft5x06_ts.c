...
#define FT5X0X_RESET_PIN	16//S5PV210_GPB(2)
#define FT5X0X_RESET_PIN_NAME	"ft5x0x-reset"
#define FT5X0X_INT_PIN	17//S5PV210_GPB(2)
...
static int ft5x0x_read_Touchdata(struct ft5x0x_ts_data *data)
{
	...
	if(buf[1]==0x03)
	{
		...
		input_report_abs(data->input_dev, ABS_MT_PRESSURE,300);
...
//---
	...
	ft5x0x_ts->irq = gpio_to_irq(FT5X0X_INT_PIN);//IRQ_EINT(14);//client->irq;	
